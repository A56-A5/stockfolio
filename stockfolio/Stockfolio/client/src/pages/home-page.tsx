    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg mb-8">Get insights, learn strategies, and make informed decisions with Stockfolio's powerful prediction tools. We're making financial opportunities accessible for everyone, especially those from low-income backgrounds.</p>
              <Link href="/auth">
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">Join thousands of investors from all income levels who are already using Stockfolio to build wealth and secure their financial future.</p>
          <Link href="/auth">
