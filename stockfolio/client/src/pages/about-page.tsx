  ...
  const teamMembers = [
    {
      name: "Robert Chen",
      role: "CEO & Founder",
      bio: "Former investment banker with 15 years of experience in financial markets and technology.",
      imageUrl: `https://randomuser.me/api/portraits/men/42.jpg`
    },
    {
      name: "Maya Patel",
      role: "CTO",
      bio: "AI and machine learning expert specializing in predictive financial models and algorithms.",
      imageUrl: `https://randomuser.me/api/portraits/women/42.jpg`
    },
    {
      name: "James Wilson",
      role: "Head of Education",
      bio: "Former financial literacy professor with a passion for making complex concepts accessible.",
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4">Our mission is to democratize stock market investing by providing educational resources, advanced analytics, and AI-powered predictions that help investors of all experience levels make informed decisions.</p>
              <p className="text-muted-foreground">We're committed to transparency, accuracy, and putting our users' financial wellbeing first.</p>
            </div>
